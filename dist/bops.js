...
module.exports = {
  ...
  , writeUInt64LE:   write_uint64_le
  , writeInt16LE:    write_int16_le
  , writeInt32LE:    write_int32_le
  , writeInt64LE:    write_int64_le
...
function write_uint64_le(target, value, at) {
  var dv = map.get(target);
  return dv.setBigUint64(at + target.byteOffset, value, true)
}
...
function write_int64_le(target, value, at) {
  var dv = map.get(target);
  return dv.setInt64(at + target.byteOffset, value, true)
}
